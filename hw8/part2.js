...
window.onload = function init()
{
    ...
    function render() {
        ...
        var debug_eye = vec3(0, cameraRadius * 2, -3);
        var debug_at = vec3(0, -1, -3);
        var debug_up = vec3(0.0, 0.0, -1.0);

        var eye =  vec3(0, 1, cameraRadius);
        var at = vec3(0, 0, -3);
        ...
        var lightPosition = 
            mult(centerMatrix, vec4(lightRadius * Math.sin(lightTheta), 8, lightRadius * Math.cos(lightTheta), 1));

...
window.onload = function init()
{
    ...
    const program = createProgram( gl, "vertex-shader1", "fragment-shader1" );
    ...
    gl.uniform4fv(gl.getUniformLocation(program, "visibility"), DEFAULT_VISIBILITY);
    ...
    function render() {
        ...
        m[3][3] = 0.0;
        m[3][1] = -1.0/(lightPosition[1] - (ground_points[0][1] - EPSILON)); // add small value to avoid flickering
        ...
        // Visibility: Black
        gl.uniform4fv(gl.getUniformLocation(program, "visibility"), vec4(0, 0, 0, 1));
